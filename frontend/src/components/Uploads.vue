                ...
                <div class="col-lg-2 mt-5"> 
                    ...
                    <div style="position: absolute; bottom: 0px;">
                       ...
                       <p class="item-description2 text-muted">
                        ...
                        <button class="btn  btn-primary text-center col-md-12 " @click= "$router.go(-1)" > <i class="fas fa-arrow-left"></i>   Previous  </button>                         
            ...
            <div class="col-lg-8 full-height"> 
                    <div class=" ">
                        ...
                        <div class= "filezone" v-if="loading">
                                ...
                                <i class="fas fa-check fa-5x "  style="color:green;"></i> Upload Successful
                        ...
                        <!-- display loading   -->
                          ...
                          <div  v-else class=" filezone my-3 mx-3 text-center " @dragover="dragover" @dragleave="dragover" @drop="drop" >
                        ...
                        <!-- display files uploaded  -->
                            ...
                            <div class="in-content">
                                <input type="file" multiple id="id_files" class="inputfile" @change="inputFile">
                                <label for="id_files"> To Upload Files, Click Here or Drag and Drop
                ...
                <div class="col-lg-2 mt-5">
                    ...
                    <div style="position: absolute; bottom: 0px;">
                        ...
                        <button  class="btn btn-primary text-center col-md-12" @click.prevent="next"> Next Step <i class="fas fa-arrow-right"></i> </button>
...
export default {
    ...
    mounted (){
        axios.get(`http://127.0.0.1:8000/api/uploads/${this.$route.params.id}/`
        ).then( (res) => {
