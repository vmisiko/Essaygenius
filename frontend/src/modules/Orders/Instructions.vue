            ...
            <div class="ant-card text-left px-3 py-4">
              <div class="form-group">
                ...
                <input
                  ...
                  name="topic"
                  maxlength="255"
                  class=" textInput form-control form-control"
                  id="id_topic"
                  required
                />
              </div>
...
export default {
  ...
  mounted() {
    axios
      .get(`http://127.0.0.1:8000/api/instructions/${this.$route.params.id}/`)
      .then(res => {
  ...
  methods: {
    ...
    submit() {
      ...
      axios
        .post(
          `http://127.0.0.1:8000/api/instructions/${this.$route.params.id}/`,
          {
            body: { id: this.$route.params.id, form: this.form }
          }
        )
        .then(res => {
          console.log(res.data);
